...
def parse_gff_record(line: str) -> Optional[GFFRecord]:
    ...
    if not transcript_id or (not transcript_id.startswith('NM_') and not transcript_id.startswith('NR_')) or not parent_id:
        return
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument("gff_file", type=argparse.FileType('rb'), help="Path to the gzipped GFF file")
