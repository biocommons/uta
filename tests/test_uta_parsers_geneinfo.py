...
data_dir = os.path.realpath(
    os.path.realpath(os.path.join(__file__, '../data')))

# gzip -cd misc/data/ftp.ncbi.nih.gov/gene/DATA/gene_info.gz | grep ^9606
# | head -101 | gzip -c >tests/data/gene_info_100human.gz
